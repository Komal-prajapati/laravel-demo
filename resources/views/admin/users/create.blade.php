                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="px-6 py-4 grid grid-col-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-input id="confirm_password" class="block mt-1 w-full" type="password" name="confirm_password" required />
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 grid grid-col-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-input id="pin_code" class="block mt-1 w-full" type="text" name="pin_code" :value="old('pin_code')" />
                        </div>
                    </div>
